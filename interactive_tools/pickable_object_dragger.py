...
class PickableObjectDragger(DragDropEventManager):
    """ a dragger object gets assigned a pickable object, and
    dragger objects are managed by DragAnesdDropObjetsManager.
    it bundles the relevant information about a drag's state """
    def __init__(self, pickable_object, camera_gear):
        """ """
        self.pickable_object = pickable_object
        self.camera_gear = camera_gear

        # FIXME: figure out a better way than passing the nodepath in here
        self._dragger_nodepath_handle = pickable_object.get_p3d_nodepath()
    ...
    def init_dragging(self):
        ...
        r0_obj = math_utils.p3d_to_np(self.pickable_object.getPos())
