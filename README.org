...
* Development Notes
** Integration
- [ ] uncouple the dragging behaviour of interfaces of edgeplayer and the one for panning in Orbiter (dragging should only be ever triggered in exactly one of them)
