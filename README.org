...
- make an animated plot in the 2d frame with a queue of frames of of xy data
  - make a set of xy data frames and cycle through these frames, updating the plot
