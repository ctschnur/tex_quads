* tex_quads
I developed this program with the idea in mind of creating an animation engine similar to the fantastic [[https://github.com/3b1b/manim][manim]], to put my own spin on mathematical visualization. It builds on the powerful panda3d engine, which is a game engine developed in C++, with Python bindings. 
