...
*** DEFERRED create shaded triangulated Cone procedurally
...
**** TODO flat shading of a simple mesh from Blender
**** DEFERRED calculate surface normals manually for the cone (for flat shading)
***** Draw 3d arrowheads
****** Shaded
